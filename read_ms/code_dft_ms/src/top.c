...
void config_struct_set_up_v2(int GRID_SIZE, int NUM_KERNELS, int NUM_BASELINES, int TOTAL_KERNEL_SAMPLES, int OVERSAMPLING_FACTOR,OUT Config *config_struct) {
	...
	// input files
	config_struct->visibility_source_file = "../sim_small.ms";
	//config_struct->visibility_source_file				= "data/input/GLEAM_small_visibilities_corrupted.csv";
	...
	config_struct->kernel_real_file    = "data/input/kernels/small/w-proj_kernels_real_x16_2458_image.csv";
	config_struct->kernel_imag_file    = "data/input/kernels/small/w-proj_kernels_imag_x16_2458_image.csv";
	config_struct->kernel_support_file = "data/input/kernels/small/w-proj_supports_x16_2458_image.csv";
	config_struct->degridding_kernel_real_file    = "data/input/kernels/small/w-proj_kernels_real_x16_2458_image.csv";
	config_struct->degridding_kernel_imag_file    = "data/input/kernels/small/w-proj_kernels_imag_x16_2458_image.csv";
	config_struct->degridding_kernel_support_file = "data/input/kernels/small/w-proj_supports_x16_2458_image.csv";
...
void psf_host_set_up2(int GRID_SIZE, int PSF_GRID_SIZE, Config *config, PRECISION *psf, double *psf_max_value) {
