...
MODES=(
    [g2g]="code_g2g_joint_nnode_ms g2g.csv G2G_Pipeline"
    [fft]="code_fft_joint_nnode_ms fft.csv FFT_Pipeline"
    [dft]="code_dft_joint_nnode_ms dft.csv DFT_Pipeline"
)
...
run_mode() {
    ...
    NUM_VIS_values=(50958 164198 1477782 14777820 14777820) #SB155.rebin = 1477782
